...
const styles = StyleSheet.create({
  ...
  filterHint: { paddingHorizontal: spacing.xl, paddingTop: spacing.xs, fontSize: 11, fontFamily: 'CormorantGaramond_400Regular_Italic', color: colors.textMuted, letterSpacing: 0.3 },
