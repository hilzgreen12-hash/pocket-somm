...
const styles = StyleSheet.create({
  ...
  cardChef: { fontSize: 14, fontFamily: 'CormorantGaramond_400Regular_Italic', color: colors.gold },
  cardWine: { fontSize: 14, fontFamily: 'CormorantGaramond_400Regular', color: colors.text },
  cardLocation: { fontSize: 14, fontFamily: 'CormorantGaramond_400Regular_Italic', color: colors.textMuted },
  cardScore: { fontSize: 14, fontFamily: 'CormorantGaramond_600SemiBold', color: colors.gold, marginTop: spacing.xs },
  cardNote: { fontSize: 15, fontFamily: 'CormorantGaramond_400Regular_Italic', color: colors.text, lineHeight: 20, marginTop: spacing.xs },
  ...
  assignEmpty: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 15, color: colors.textMuted, textAlign: 'center', paddingVertical: spacing.xl },
});
