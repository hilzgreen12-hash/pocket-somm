...
const styles = StyleSheet.create({
  ...
  modalBody: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 14, color: 'rgba(255,255,255,0.75)', textAlign: 'center', lineHeight: 20, marginBottom: spacing.md },
