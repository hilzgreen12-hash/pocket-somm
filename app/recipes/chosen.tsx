...
const styles = StyleSheet.create({
  ...
  folderChipLabel: { fontFamily: fonts.bodySemibold, fontSize: 13, color: colors.text },
  folderChipLabelActive: { color: colors.gold },
  folderChipCount: { fontFamily: fonts.bodyRegular, fontSize: 12, color: colors.textMuted },
  ...
  newFolderChipText: { fontFamily: fonts.headingSemibold, fontSize: 13, color: colors.gold },
  ...
  signInBtnText: { fontFamily: fonts.headingSemibold, fontSize: 15, color: colors.gold },
  ...
  cardChef: { fontSize: 14, fontFamily: fonts.bodyItalic, color: colors.gold },
  cardWine: { fontSize: 14, fontFamily: fonts.bodyRegular, color: colors.text },
  cardLocation: { fontSize: 14, fontFamily: fonts.bodyItalic, color: colors.textMuted },
  cardScore: { fontSize: 14, fontFamily: fonts.bodySemibold, color: colors.gold, marginTop: spacing.xs },
  cardNote: { fontSize: 15, fontFamily: fonts.bodyItalic, color: colors.text, lineHeight: 20, marginTop: spacing.xs },
  ...
  assignLink: { fontFamily: fonts.headingSemibold, fontSize: 13, color: colors.gold },
  ...
  modalTitle: { fontFamily: fonts.headingBold, fontSize: 22, color: colors.text, textAlign: 'center', marginBottom: spacing.xs },
  modalBody: { fontFamily: fonts.bodyRegular, fontSize: 15, color: '#FFFFFF', textAlign: 'center', lineHeight: 20, marginBottom: spacing.md },
  modalInput: { borderWidth: 1, borderColor: colors.border, borderRadius: 8, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, fontSize: 16, fontFamily: fonts.bodyRegular, color: colors.text, backgroundColor: colors.surface, marginBottom: spacing.md },
  ...
  modalButtonTextDanger: { color: colors.gold },
  ...
  assignOptionText: { fontFamily: fonts.bodySemibold, fontSize: 16, color: colors.text },
  assignOptionTextActive: { color: colors.gold },
  assignCheck: { fontFamily: fonts.bodyBold, fontSize: 18, color: colors.gold, marginLeft: spacing.sm },
  assignEmpty: { fontFamily: fonts.bodyItalic, fontSize: 15, color: colors.textMuted, textAlign: 'center', paddingVertical: spacing.xl },
});
