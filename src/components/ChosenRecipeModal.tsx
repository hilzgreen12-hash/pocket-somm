...
const styles = StyleSheet.create({
  ...
  chefInspiration: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 14, color: colors.gold, textAlign: 'center', marginBottom: spacing.sm },
  ...
  scoreHint: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 12, color: colors.textMuted, marginBottom: spacing.lg },
