...
const styles = StyleSheet.create({
  ...
  brandTagline: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 29, color: 'rgba(255,255,255,0.55)', marginTop: 6, letterSpacing: 1.5 },
  divider: { height: 1, backgroundColor: 'rgba(212,176,96,0.55)', marginVertical: 28 },
  subhead: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 30, color: 'rgba(212,176,96,0.85)', textTransform: 'uppercase', letterSpacing: 6, textAlign: 'center', marginBottom: 20 },
  ...
  stampLocation: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 26, color: 'rgba(255,255,255,0.80)', marginTop: 6 },
  ...
  scoreUnit: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 20, color: 'rgba(255,255,255,0.65)' },
  wineName: { fontFamily: 'CormorantGaramond_700Bold', fontSize: 30, color: '#FFFFFF', lineHeight: 36, marginBottom: 6 },
  wineDetail: { fontFamily: 'CormorantGaramond_400Regular', fontSize: 22, color: 'rgba(255,255,255,0.72)', lineHeight: 28 },
  footer: { alignItems: 'center', marginTop: 24 },
  footerLine: { fontFamily: 'CormorantGaramond_700Bold', fontSize: 22, color: colors.gold, letterSpacing: 4 },
  footerCta: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 24, color: 'rgba(255,255,255,0.55)', marginTop: 6 },
});
